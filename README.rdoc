...
== THIS PROJECT IS NO LONGER MAINTAINED -10/15/09

The latest release of the Unobtrusive Date-Picker Widget Javascript library (http://frequency-decoder.com/2009/09/09/unobtrusive-date-picker-widget-v5) makes this plugin unnecessary so I've decided to no longer maintain it.
